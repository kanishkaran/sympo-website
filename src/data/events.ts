...
export const events: Event[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      "Round 1: Quiz: General Cricket Quiz",
      "Top 10 teams qualify for Round 2",
      "Round 2: IPL Auction",
      "Auction players list will be provided 15 minutes before the auction",
      "Budget: ₹75 Cr",
      "Teams exceeding the budget will be eliminated",
      "Squad: 15 players (11 in Playing XI, 4 as impact subs)",
      "Max 10 Indian players",
      "Max 5 foreign players (only 4 in Playing XI)",
      "Each team will have 1 RTM Card (New RTM rules will be applied)",
      "Evaluation will be based on team quality, combination, and impact",
